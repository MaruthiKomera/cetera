...
CREATE INDEX CETERA.ANSWERS_IDX1 ON CETERA.ANSWERS ( I_QUANTIFY_ID );
CREATE INDEX CETERA.ANSWERS_IDX2 ON CETERA.ANSWERS ( QUESTION_ID );
CREATE INDEX CETERA.SESSIONS_IDX ON CETERA.SESSIONS ( PERSON_ID );
CREATE INDEX CETERA.PERSON_IDX ON CETERA.PERSON (BD_ID);
CREATE INDEX CETERA.RESOURCES_QA_IDX1 ON CETERA.RESOURCES_QA (BD_QA_ID);
CREATE INDEX CETERA.RESOURCES_QA_IDX2 ON CETERA.RESOURCES_QA (RES_ID);
CREATE INDEX CETERA.REVENUE_IDX ON CETERA.REVENUE (PERSON_ID);
CREATE INDEX CETERA.IQUANTIFY_IDX1 ON CETERA.IQUANTIFY (QUESTIONNAIRE_ID);
CREATE INDEX CETERA.IQUANTIFY_IDX2 ON CETERA.IQUANTIFY (PERSON_ID);
CREATE INDEX CETERA.IQUANTIFY_IDX3 ON CETERA.IQUANTIFY (PERSON_ID, CREATED_ON);
CREATE INDEX CETERA.BD_QA_IDX1 ON CETERA.BD_QA (BD_ID);
CREATE INDEX CETERA.BD_QA_IDX2 ON CETERA.BD_QA (QUESTIONNAIRE_ID);